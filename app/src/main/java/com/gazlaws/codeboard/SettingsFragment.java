...
public class SettingsFragment extends PreferenceFragmentCompat implements IOnFocusListenable {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        // Only allow numbers
        String[] numberOnlyPreferences = {"vibrate_ms", "font_size", "size_portrait", "size_landscape", "sound_volume", "repeat_interval", "initial_repeat_delay", "spacebar_layout_index"};
